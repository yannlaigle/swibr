...
# EasyAdapter rules
-keepclassmembers class * extends com.swibr.app.easyadapter.ItemViewHolder {
    public <init>(...);
 }
...
-keepclassmembers class com.swibr.app.data.model.** {
...
-keepclassmembers class com.swibr.app.data.remote.SwibrsService$** {
    !static !private <fields>;
}
